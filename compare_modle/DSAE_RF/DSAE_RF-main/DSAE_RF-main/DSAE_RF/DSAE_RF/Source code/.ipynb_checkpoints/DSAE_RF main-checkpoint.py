...
MD = pd.read_csv("E:/Data/MD_A.csv",index_col=0)
MD
...
DS = pd.read_csv("E:/Data/DS.csv",index_col=0)
DS
...
net.load_state_dict(torch.load( 'E:/Data/DSAE_RF.pth'))


# In[8]:


torch.load('E:/Data/DSAE_RF.pth')
